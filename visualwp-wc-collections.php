 ...
 * @since             1.0.0
 * @package           VisualWP Collections for Woocommerce
 *
 * @wordpress-plugin
 * Plugin Name:       VisualWP Collections for Woocommerce
 * Plugin URI:        https://sightfactory.com/visualwp-collections/
 * Description:       Create collections of similar products based on categories, tags, product name and more for your WooCommerce store
 * Version:           1.0.5
 * Author:            Sightfactory
